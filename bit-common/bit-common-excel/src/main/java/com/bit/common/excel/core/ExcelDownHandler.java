package com.bit.common.excel.core;
...
import com.bit.common.core.service.DictService;
...
import com.bit.common.excel.annotation.ExcelEnumFormat;
...
public class ExcelDownHandler implements SheetWriteHandler {
     ...
     * 下拉可选项
     */
    private final List<com.bit.common.excel.core.DropDownOptions> dropDownOptions;
    /**
     * 当前单选进度
     */
    ...
    public ExcelDownHandler(List<com.bit.common.excel.core.DropDownOptions> options) {
     ...
     */
    private void dropDownLinkedOptions(DataValidationHelper helper, Workbook workbook, Sheet sheet, com.bit.common.excel.core.DropDownOptions options) {
